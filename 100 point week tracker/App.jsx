    ...
    <div className="tracker-container">
      ...
      <div className="week-card">
        <div className="week-header">
          <h2>This week</h2>
          <span className="week-dates">{weekStart} to {weekEnd}</span>
        </div>
        <div className="week-points">
          {weekPoints} <span className="week-goal">/ 100 points</span>
        </div>
        <div className="progress-bar">
          <div className="progress-fill" style={{ width: weekPercent + '%' }}></div>
        </div>
      </div>

      {/* Today's Activities */}
      <div className="today-section">
        <h3>Today ({today}) — {todayPoints} points</h3>
      ...
      <div className="info-box">
        ℹ️ All data saved locally. Log activities the same day for accurate tracking.
      </div>
    </div>
  );
};
